...
# Count apps that added any category
def count_all_added_categories(data1, data2):
    ...
    added_category_counts = defaultdict(int)
...
def plot_all_added_categories(counts, title):
...
# Count apps that added any category
all_added_category_counts = count_all_added_categories(data_may_12_2024, data_dec_15_2024)

# Plot the result
plot_all_added_categories(all_added_category_counts, 'Apps Adding Categories: May 12, 2024 to Dec 15, 2024')